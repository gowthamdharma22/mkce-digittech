      ...
      <Navbar fluid rounded  className="navv">
        <Navbar.Brand>
          <img
            ...
            src="img/logo.png"
          />
          <span id="nav-tit" className="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">
            MKCS DigitTech <span className="sol">solutions</span>
          </span>
        </Navbar.Brand>
        <div className="flex md:order-2">
        <button className="btn" id="nav-btn">Get Started</button>
          <Navbar.Toggle />
        </div>
        <Navbar.Collapse>
          ...
          <Navbar.Link href="#" className="text-xl">Team</Navbar.Link>
        </Navbar.Collapse>
      </Navbar>
    </div>
  );
